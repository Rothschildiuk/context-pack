...
```bash
curl -LO https://github.com/Rothschildiuk/context-pack/releases/download/v0.4.1/context-pack-v0.4.1-<target>.tar.gz
tar -xzf context-pack-v0.4.1-<target>.tar.gz
